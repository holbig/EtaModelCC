...
# getClimateData(modelID, modelFrequency, modelVar, lat, lon, iYear, fYear)
getClimateData('1', 'YEARLY', 'TP2M', '-28.35', '-52.34', iYear = 2006, fYear = 2010)
getClimateData('3', 'YEARLY', 'TP2M', '-28.35', '-52.35', 2006, 2010)
getClimateData('5', 'MONTHLY','TP2M', '-28.35', '-52.35', 2006, 2008)
getClimateData('1', 'DAILY',  'TP2M', '-28.35', '-52.35', 2006, 2006)
getClimateData('1', 'HOURLY', 'TP2M', '-28.35', '-52.35', 2006, 2006)

# getClimateDataBr(modelID, modelFrequency, modelVar, iYear, fYear)
